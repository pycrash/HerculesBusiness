...
public class CompletedOrderCustomerAdapter extends RecyclerView.Adapter<CompletedOrderCustomerAdapter.MyOrderHolder>  {

    List<OrderModel> listData;
    Context context;
    String TAG = "My Orders";

    public CompletedOrderCustomerAdapter(Context context, List<OrderModel> listData) {
    ...
    class MyOrderHolder extends RecyclerView.ViewHolder implements Serializable {
        ...
        public CardView view_details, approve_order;
    ...
    public void onBindViewHolder(@NonNull MyOrderHolder holder, int position) {
        ...
        holder.view_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailedCompleteOrder.class);
