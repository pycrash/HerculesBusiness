...
public class CompletedOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.orders_completed);
    ...
    void checkInternet() {
        androidx.appcompat.app.AlertDialog.Builder mBuilder = new androidx.appcompat.app.AlertDialog.Builder(CompletedOrdersActivity.this);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                boolean isInternet = CheckInternetConnection.checkInternet(CompletedOrdersActivity.this);
                if (!isInternet) {
                    dialog.show();
                } else {
                    dialog.hide();
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new FragmentCustomerViewCompleted(), "Customer View");
        adapter.addFragment(new FragmentOrderViewCompleted(), "Order View");
