 ...
 * Use the {@link FragmentCustomerViewCompleted#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentCustomerViewCompleted extends Fragment {
    RecyclerView recyclerView;
    List<OrderModel> list;
    CompletedOrderCustomerAdapter adapter;
    ...
    public FragmentCustomerViewCompleted() {
    ...
    public static FragmentCustomerViewCompleted newInstance(String param1, String param2) {
        FragmentCustomerViewCompleted fragment = new FragmentCustomerViewCompleted();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    adapter = new CompletedOrderCustomerAdapter(getContext(), list);
