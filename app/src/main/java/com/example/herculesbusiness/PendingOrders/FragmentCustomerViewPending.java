 ...
 * Use the {@link FragmentCustomerViewPending#newInstance} factory method to
 * create an instance of this fragment.
 */
public class FragmentCustomerViewPending extends Fragment {
    RecyclerView recyclerView;
    List<OrderModel> list;
    PendingOrderCustomerAdapter adapter;
    ...
    public FragmentCustomerViewPending() {
    ...
    public static FragmentCustomerViewPending newInstance(String param1, String param2) {
        FragmentCustomerViewPending fragment = new FragmentCustomerViewPending();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    adapter = new PendingOrderCustomerAdapter(getContext(), list);
