...
public class OrdersViewCustomerActivity extends AppCompatActivity{
    ...
    private OrdersCustomersAdapter viewCustomerAdapter;
    ...
    private void initProductsAdapter() {
        viewCustomerAdapter = new OrdersCustomersAdapter(customerList, OrdersViewCustomerActivity.this);
                ...
                public void onChanged(Operation operation) {
                    switch (operation.type) {
                        case R.string.added:
                            ...
                            OrdersViewCustomerActivity.this.addProduct(addedCustomer);
                            break;

                        case R.string.modified:
                            Customer modifiedCustomer = operation.customer;
                            OrdersViewCustomerActivity.this.modifyProduct(modifiedCustomer);
                            break;

                        case R.string.removed:
                            Customer removedCustomer = operation.customer;
                            OrdersViewCustomerActivity.this.removeProduct(removedCustomer);
                    }
    ...
    void checkInternet() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(OrdersViewCustomerActivity.this);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                boolean isInternet = CheckInternetConnection.checkInternet(OrdersViewCustomerActivity.this);
                if (!isInternet) {
                    dialog.show();
                } else {
                    dialog.hide();
