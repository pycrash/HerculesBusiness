...
public class CustomerView extends AppCompatActivity {
    ...
    private ViewCustomerTradingAdapter viewCustomerAdapter;
    ...
    private void initProductsAdapter() {
        viewCustomerAdapter = new ViewCustomerTradingAdapter(customerList, CustomerView.this);
                ...
                public void onChanged(Operation operation) {
                    switch (operation.type) {
                        case R.string.added:
                            ...
                            CustomerView.this.addProduct(addedCustomer);
                            break;

                        case R.string.modified:
                            Customer modifiedCustomer = operation.customer;
                            CustomerView.this.modifyProduct(modifiedCustomer);
                            break;

                        case R.string.removed:
                            Customer removedCustomer = operation.customer;
                            CustomerView.this.removeProduct(removedCustomer);
                    }
    ...
    void checkInternet() {
        androidx.appcompat.app.AlertDialog.Builder mBuilder = new androidx.appcompat.app.AlertDialog.Builder(CustomerView.this);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                boolean isInternet = CheckInternetConnection.checkInternet(CustomerView.this);
                if (!isInternet) {
                    dialog.show();
                } else {
                    dialog.hide();
