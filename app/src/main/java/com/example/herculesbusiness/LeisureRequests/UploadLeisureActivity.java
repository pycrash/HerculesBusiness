...
public class UploadLeisureActivity extends AppCompatActivity {
    AlertDialog dialog;
    EditText mPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.trading_leisure);
    ...
    void initDialog() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(UploadLeisureActivity.this);
    ...
    private void uploadFile(Uri data) {
        progressDialog = new ProgressDialog(UploadLeisureActivity.this, R.style.ProgressDialog);
        ...
        StorageReference sRef = mStorageReference.child(TradingConstants.STORAGE_PATH_UPLOADS_LEISURE + System.currentTimeMillis() + ".pdf");
        sRef.putFile(data)
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        sRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                request = database.getReference(name).child("Leisure");
    ...
    private void deleteFromLeisure() {
        DocumentReference documentReference = db.collection("Leisure").document(email);
    ...
    private void loadOrders() {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference(name).child("Leisure");
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for(DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    adapter = new ViewTradingAdapter(uploadList, UploadLeisureActivity.this);
    ...
    void checkInternet() {
        androidx.appcompat.app.AlertDialog.Builder mBuilder = new androidx.appcompat.app.AlertDialog.Builder(UploadLeisureActivity.this);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                boolean isInternet = CheckInternetConnection.checkInternet(UploadLeisureActivity.this);
                if (!isInternet) {
                    dialog1.show();
                } else {
                    dialog1.hide();
