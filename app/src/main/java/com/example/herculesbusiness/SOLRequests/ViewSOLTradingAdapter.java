...
public class ViewSOLTradingAdapter extends RecyclerView.Adapter<ViewSOLTradingAdapter.ProductViewHolder> {
    private List<Customer> customerList;
    Context context;


    ViewSOLTradingAdapter(List<Customer> customerList, Context context) {
