...
public class NewOrderCustomerAdapter extends RecyclerView.Adapter<NewOrderCustomerAdapter.MyOrderHolder>  {

    List<OrderModel> listData;
    Context context;
    String TAG = "My Orders";

    public NewOrderCustomerAdapter(Context context, List<OrderModel> listData) {
    ...
    public void onBindViewHolder(@NonNull MyOrderHolder holder, int position) {
        ...
        holder.view_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailedNewOrderActivity.class);
